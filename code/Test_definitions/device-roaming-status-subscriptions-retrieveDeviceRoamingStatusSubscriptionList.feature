...
Feature: Device Roaming Status Subscriptions API, v0.9.0-rc.1 - Operation retrieveDeviceRoamingStatusSubscriptionList
  ...
  Background: Common Device Roaming Status Subscriptions setup
    Given the resource "{apiroot}/device-roaming-status-subscriptions/v0.9rc1/subscriptions" as base-url
