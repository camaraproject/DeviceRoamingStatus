...
Feature: CAMARA Device Roaming Status API, v1.2.0-rc.3 - Operation getRoamingStatus
  ...
  Background: Common getRoamingStatus setup
    Given the resource "{api-root}/device-roaming-status/v1rc3/retrieve" set as base-url
