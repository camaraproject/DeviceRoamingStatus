...
Feature: CAMARA Device Roaming Status API, v1.1.0-rc.1 - Operation getRoamingStatus
  ...
  Background: Common getRoamingStatus setup
    Given the resource "{api-root}/device-roaming-status/v1rc1/retrieve" set as base-url
